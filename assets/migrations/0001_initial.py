    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(blank=True, choices=[('AWS', 'AWS'), ('GCS', 'GCS')], max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('CLOUD', 'CLOUD'), ('SELF_RECORD', 'SELF_RECORD')], default='CLOUD', max_length=250, null=True)),
                ('is_re_record', models.BooleanField(default=True)),
                ('audio', models.FileField(blank=True, null=True, upload_to='Audios')),
                ('voice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='assets.voice')),
            ],
            options={
                'ordering': ['text'],
            },
