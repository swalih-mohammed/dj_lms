...
function PrivacyPolicy() {
  return (
      <Container>
          <Typography sx={{pb:1, pt: 3, color: "#023047"}} variant="h5">Privacy Policy</Typography>
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="body2" >
              ...
              you, including across our website, https://laamacademy.com, and
              other sites we own and operate. This policy is effective as of 28
              November 2021 and was last updated on 28 June, 2022.
            </Typography>
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="h6" >
            ...
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="h6" >Log Data</Typography>
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="body2" >
            ...
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="h6" >Personal Information</Typography>
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="body2" >
            ...
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="h2" >Use of Cookies</Typography>
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="body2" >
            ...
            <Typography  sx={{pb:1, pt: 1, color: "#023047"}}  variant="h6">Limits of Our Policy</Typography>
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="body2" >
            ...
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="body2" >Contact Us</Typography>
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="body2" >
              For any questions or concerns regarding your privacy, you may
              contact us using the following details:
            </Typography>
            <Typography sx={{pb:1, pt: 1, color: "#023047"}}  variant="body2" >
              Laam Academy LLC <br></br> support@laamacademy.com
            </Typography>
